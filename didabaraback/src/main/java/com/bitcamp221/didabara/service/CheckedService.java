...
//  마지막 수정자 : 문병훈
//  -----------------------------------------------------
  public List<UserEntity> create(final CheckedEntity checkedEntity) {
    ...
    try {
      ...
      return checkedRepository.checkUserList(checkedEntity.getCategoryItem());
    } catch (Exception e) {
...
//  마지막 수정자 : 문병훈
//  -----------------------------------------------------
  public List<UserEntity> findCheckUserList(final Long categoryItemId) {
...
//  마지막 수정자 : 문병훈
//  -----------------------------------------------------
  public List<CategoryItemEntity> findUnCheckUserList(final Long categoryItemId, final Long userId) {
...
//  마지막 수정자 : 문병훈
//  -----------------------------------------------------
  public List<UserEntity> findMyUnCheckList(final Long userId) {
  ...
  public List<UserEntity> checkUserList(final Long categoryId) {
    final String message = "checkedService checkUserList";
    ...
    try {
      ...
      return checkedRepository.checkUserList(categoryId);
    } catch (Exception e) {
      log.error(LogMessage.errorJoin(message));
